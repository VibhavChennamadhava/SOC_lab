# Wazuh SOC Home Lab (Single-File Documentation)
...
## Notes
- All screenshots are referenced from `./screenshots/`.
- This document intentionally avoids external links except Wazuh workflow references already reflected from lab content.
